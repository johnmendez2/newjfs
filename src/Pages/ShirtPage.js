      ...
      <div>
        ...
        {showFooter && <div className="mobile-layout">
          ...
          <div className="mobile-top">
            ...
            <button className="offer-btn" onClick={() => window.open('https://www.instagram.com/johnsfootballshirts/')}>
                  MAKE OFFER
                </button>
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div className="productDesc">
                ...
                <button className="depop-btn" onClick={() => window.open(prod.depopURL)}>BUY VIA DEPOP</button>
                <button className="offer-btn" onClick={() => window.open('https://www.instagram.com/johnsfootballshirts/')} style={{ marginLeft: '20px' }}>
                  MAKE OFFER
                </button>
                <h3>Shipping:</h3>
                <p className="description">
